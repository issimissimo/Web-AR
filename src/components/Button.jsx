...
const StyledButton = styled(Motion.button)`
    ...
    background: var(--color-primary-dark-dark);
    border: ${(props) => (props.border ? (props.small ? "1px solid" : "1px solid") : "1px solid")};
    /* border: none; */
    border-color: ${(props) =>
        props.border ? (props.grey ? "var(--color-grey)" : "var(--color-primary)") : "transparent"};
